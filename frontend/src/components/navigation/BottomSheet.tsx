...
import { StickyNote, Search, Settings, Circle, ShoppingCart, ClipboardList, Package, LayoutGrid } from 'lucide-react'
...
const sheetItems: SheetItem[] = [
  ...
  { icon: Package, label: 'Off-Catalog', path: '/off-catalog' },
